export default function PendingPage() {
  return (
    <div className="space-y-6">
      {/* 페이지 헤더 */}
      <div>
        <h1 className="text-2xl font-bold text-primary">미결함</h1>
        <p className="text-secondary mt-1">결재할 문서들을 확인하세요</p>
      </div>
      ...
      <div className="bg-surface border border-border rounded-lg">
        <div className="p-6 border-b border-border">
          <h2 className="text-lg font-semibold text-primary">결재 대기 문서</h2>
        </div>
            ...
            <tbody className="divide-y divide-border">
              <tr className="hover:bg-surface/50">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  ...
                  <button className="text-success hover:text-success/80 mr-3">
                    승인
                  </button>
