export default function CompletedPage() {
  return (
    <div className="space-y-6">
      {/* 페이지 헤더 */}
      <div>
        <h1 className="text-2xl font-bold text-primary">기결함</h1>
        <p className="text-secondary mt-1">결재 완료된 문서들을 확인하세요</p>
      </div>
      ...
      <div className="bg-surface border border-border rounded-lg">
        <div className="p-6 border-b border-border">
          <h2 className="text-lg font-semibold text-primary">결재 완료 문서</h2>
        </div>
